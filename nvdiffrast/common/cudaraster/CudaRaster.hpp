...
public:
    ...
    bool                    drawTriangles           (const int* ranges, bool peel, STREAM stream); // Ranges (offsets and counts) as #triangles entries, not as bytes. If NULL, draw all triangles. Returns false in case of internal overflow.
